  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: {title: '新共享影视页面', keepAlive: false, isShowHead: false, isShowTab: false, routerZindex: 2}
        },
        {
          path: '/videoSearch',
          name: 'videoSearch',
        ...
        },
        {
          ...
          meta: {title: '转出到集分宝', keepAlive: false, isShowHead: true, isShowTab: false, routerZindex: 3}
        },
        {
          path: '/exchange',
          name: 'exchange',
        ...
        },
        {
          path: '/partnerships',
          name: 'partnerships',
          component: resolve => require(['@/pages/my/partnerships'], resolve),
          meta: {title: '合伙人', isShowHead: true, routerZindex: 2}
        },
        {
          path: '/team',
          name: 'team',
        ...
        },
        {
          path: '/operatorcenter',
          name: 'operatorcenter',
          component: resolve => require(['../pages/my/operatorcenter.vue'], resolve),
          meta: {title: '运营商中心-数据统计', keepAlive: false, isShowSearch: false, isShowTab: false,isShowHead: false}
        },
        {
          path: '/prize',
          name: 'prize',
          component: resolve => require(['../pages/my/prize.vue'], resolve),
          meta: {title: '积分抽奖', keepAlive: false, isShowSearch: false, isShowTab: false,isShowHead: true}
        },
        //Integral bank
        {
          path: '/bank',
          name: 'bank',
          component: resolve => require(['../pages/my/bank.vue'], resolve),
          meta: {title: '积分银行', keepAlive: false, isShowSearch: false, isShowTab: false,isShowHead: true}
        },
        {
          path: '/bankdetailed',
          name: 'bankdetailed',
          component: resolve => require(['../pages/my/bankdetailed.vue'], resolve),
          meta: {title: '积分银行明细', keepAlive: false, isShowSearch: false, isShowTab: false,isShowHead: true}
        },
        {
          path: '/myrecord',
          name: 'myrecord',
          component: resolve => require(['../pages/my/myrecord.vue'], resolve),
          meta: {title: '我的记录', keepAlive: false, isShowSearch: false, isShowTab: false,isShowHead: true}
        },
        {
          path: '/shoppingnum',
          name: 'shoppingnum',
          component: resolve => require(['../pages/my/shoppingnum.vue'], resolve),
          meta: {title: '购物通积分', keepAlive: false, isShowSearch: false, isShowTab: false,isShowHead: false}
        },
        {
          path: '/myaddress',
          name: 'myaddress',
          component: resolve => require(['../pages/my/myaddress.vue'], resolve),
          meta: {title: '收货地址', keepAlive: false, isShowSearch: false, isShowTab: false,isShowHead: true}
        },
        {
          path: '/setuppwd',
          name: 'setuppwd',
          component: resolve => require(['../pages/my/setuppwd.vue'], resolve),
          meta: {title: '设置支付密码', keepAlive: false, isShowSearch: false, isShowTab: false,isShowHead: true}
        },
        {
          path: '/outintegral',
          name: 'outintegral',
          component: resolve => require(['../pages/my/outintegral.vue'], resolve),
          meta: {title: '转出购物通积分', keepAlive: false, isShowSearch: false, isShowTab: false,isShowHead: true}
        },
        {
          path: '/newsuper',
          name: 'newsuper',
          component: resolve => require(['@/pages/super/newsuper.vue'], resolve),
          meta: {title: '品牌馆', isShowTab: true, keepAlive: true,isShowHead: true}
          // routerZindex: 1
        },
        {
          path: '/ordercenter',
          name: 'ordercenter',
          component: resolve => require(['@/pages/my/ordercenter.vue'], resolve),
          meta: {title: '我的账单', isShowTab: true, keepAlive: false,isShowHead: true}
        },
      ]
    }
  ],
...
router.beforeEach(function (to, from, next) {
  var firstPage = ['/home', '/newIndex', '/sort', '/materials', '/materials2', '/super', '/materials1', '/my', '/newIndex', '/mall/home', '/mall/business', '/mall/underShop', '/mall/underShop', '/mall/my', '/mall/cart']
