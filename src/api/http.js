...
if (baseApiUrl.indexOf('192.168') !== -1 || baseApiUrl.indexOf('localhost') !== -1) {
  ...
  // baseApiUrl = 'http://app.youquanyun.com/api/' + config.bizId
  // baseApiUrl = 'http://www.9287el.cn/api/' + config.bizId
  //baseApiUrl = 'http://book.humeng88.top/api/' + config.bizId
  baseApiUrl = 'http://m.shuqian.shop/api/' + config.bizId
  // http://book.humeng88.top
}
