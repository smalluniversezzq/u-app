        ...
        <ul class="goods_ul">
          <li class="goods_li" v-for="item of list" :key="item.origin_id" @click="detail(item)">
            ...
            <div class="con_right">
              ...
              <div  v-if='item.shop' class="shoptitle">{{item.shop.title}}</div>
              ...
              <div class="up_gain" v-if="$bizId !== 1 && item.level_commission_money && item.level_commission_money != 0">
                ...
                <!-- <span v-if="item.level_commission_money && item.level_commission_money != 0 && (item.commission_money != item.level_commission_money)">:￥{{item.level_commission_money}}</span> -->
              </div>
            </div>
          </li>
        </ul>
