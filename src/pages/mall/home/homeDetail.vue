      ...
      <div class="detail_main" id="detail_main" ref="my_scroller">
        <div class="banner" style="position:relative">
          ...
          <div class="title">
            ...
            <!-- order3 -->
            <!-- font-size: 0.25rem; font-weight: normal; color: #ccc; margin-left: 0.2rem-->
            <div class="price_main"><span>积分</span>{{detailObj.credit}} 
            <div  class="commiss" v-if="detailObj.commission !=0" style="">
              佣金{{detailObj.commission}}
              </div>
              </div>
            <div class="bottom">
            ...
            <div class="header">
              <div class="header_main">
                ...
                <div class="right_main">
                  <div class="commiss">
                    <span v-if="commiss !=0">佣金 {{commiss}}</span>
                  </div>
                  <!-- ¥order7 -->
  ...
  mounted: function () {
    ...
    apiHttp.goodsDetail(this.$route.query.title).then(response => {
      if (response.code === 0) {
        ...
        this.price = response.data.detail.credit
        this.total = response.data.detail.total
        this.price1 = response.data.detail.credit
        this.commiss = response.data.detail.commission
