<template>
  <div id="home" class="homeMall">
    ...
    <div class="seach_main" v-if="$store.state.global.mallSearch" :style="{paddingTop: (statusH + 0.2) + 'rem',background: 'linear-gradient('+$store.state.global.mallSearch.bgDeg+'deg,' +$store.state.global.mallSearch.bgColor+','+$store.state.global.mallSearch.bgSecondColor+')'}">
      <div class="home_seach">
        <div class="home_seach_left backBox">
          <!--<img src="../../../assets/mall/img/home/person.png" alt="">-->
          <div style="width: 100%; height: 100%;display: flex;align-items: center;justify-content: center"  @click="jumpTo({name:'home'})" v-if="$store.state.global.firstNav === '/home'">
      ...
      <div class="linchpin" v-if="$store.state.global.mallHot" :style="{background: 'linear-gradient('+$store.state.global.mallHot.bgDeg+'deg,' +$store.state.global.mallHot.bgColor+','+$store.state.global.mallHot.bgSecondColor+')'}">
    ...
    <div class="mall-home-scroll">
      <div class="mescrollBox"  :style="{top: $store.state.global.mallHot ? (statusH + 1.8) + 'rem' : (statusH + 1) + 'rem'}">
