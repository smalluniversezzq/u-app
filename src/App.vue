  ...
  <div id="app"  v-swiperight="rightSlip">
        ...
        <div class="update">
          ...
          <div class="contentBox">
            <div class="add">
              ...
              <!--<div class="info"><span></span><p>优化APP流畅度和部分页面UI界面</p></div>-->
              <!--<div class="info"><span></span><p>新增免单福利和超级入口功能</p></div>-->
              <!--<div class="info"><span></span><p>修复已知BUG</p></div>-->
              <!--<div class="info"><span></span><p>新增免单福利和超级入口功能</p></div>-->
              <!--<div class="info"><span></span><p>新增免单福利和超级入口功能</p></div>-->
            </div>
    ...
    <div v-transfer-dom>
      <!--<x-dialog v-model="showToast3" class="updateBox">-->
        <!--&lt;!&ndash;<div class="weui-mask"></div>&ndash;&gt;-->
        <!--<div class="update">-->
          <!--<img src="./assets/img/my/update.png" alt="" class="bg">-->
          <!--<div class="contentBox">-->
            <!--<div class="add">-->
        ...
        <!--</div>-->
      <!--</x-dialog>-->
      <x-dialog v-model="showToast3" hide-on-blur :dialog-style="{'max-width': '100%', 'background-color': 'transparent'}" class="progressBox">
        <div class="progressBg">
          ...
          <div class="update_btn"  v-if="!showToast5"><span @click="showToast3 = false">稍后提醒</span><span @click="startSmart">立即升级</span></div>
        </div>
      </x-dialog>
    </div>
    <div v-transfer-dom>
...
export default {
  ...
  data () {
    return {
      ...
      colors: '',
      r: true,
      hideTitle: ['home', 'clockIn', 'paySuccess', 'regulation', 'clockInDetail', 'mallHome', 'sort', 'classify', 'newIndex', 'otherclassify', 'supergoods', 'supergoods2', 'goods', 'likegoods', 'fansDetail', 'materials', 'materials1', 'materials2', 'my', 'my1', 'my2', 'my3', 'super', 'team', 'mallMy', 'guide', 'mallSeller', 'fastrob', 'signIn', 'mallUnderGoodsDetails'],
      version: '',
      smart: '',
      transitionName: ''
    }
  ...
  computed: {
    ...
    showToastCopy () {
      return (this.showToast && !this.showToast1 && !this.showToast2 && !this.showToast3 && !this.showToast4 && this.$route.name !== 'guide' && !this.showActivity)
    },
    showActivity () {
