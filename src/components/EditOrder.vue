    ...
    <div class="EditOrder">
      <div class="order">
        <div class="order-title">
          <p>{{data.title}}</p>
          <span @click="jumpLink(data.right_url,'0')" v-if="data.right">{{data.right}}<img src="../assets/mall/img/my/right.png" alt=""></span>
        </div>
        <div class="order-list1">
          <div class="list-item1" v-for="(item, index) of data.items" :key="index" @click="jumpLink(item.link,index)">
