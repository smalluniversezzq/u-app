    ...
    <div class="firmOrder_main">
            ...
            <div class="list">
              ...
              <div class="mail" v-for="(item,index) in items.goods" :key="index">
                ...
                <div class="right">
                  ...
                  <div class="div3">
                    <!-- order1 -->
                    <div class="price_main"><span>积分</span>{{item.credit}}</div>
                  </div>
                </div>
              </div>
              <div class="li_main">
            ...
            <div class="list">
              ...
              <div class="li_main">
                ...
                <div class="title_right_red">
                  <!-- order8 -->
                  <span v-show="items.shopInfo.countCommission !='0.00'">佣金{{items.shopInfo.countCommission}}</span>
                   &nbsp;&nbsp;<span>积分</span>{{items.shopInfo.countCredit}}
                </div>
              </div>
            </div>
          </div>
          <div class="content_main" v-if="items.shopInfo.deduce" style="margin-top:0.1rem;">
            <div class="list jifen-box" style="display:none">
              <div class="line">
      ...
      <div class="footer">
          <div class="footer_main">
            <div class="div1">
              <label>合计</label><span v-if="obj.countCommission !='0.00'" >佣金{{obj.countCommission}}</span><span>积分{{obj.countCredit}}</span>
            </div>
